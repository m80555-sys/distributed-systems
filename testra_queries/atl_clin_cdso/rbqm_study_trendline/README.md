...
- `count_source.sql` returns the source-derived row count using only primary key columns.
- `count_target.sql` returns the target row count using only primary key columns.
